  ...
  return (
    <>
      <div
        ...
        className="mx-[3rem] md:mx-0 rounded overflow-hidden shadow-lg m-4 cursor-pointer"
      >
        <img src={cardImg} alt={altImg} className="w-full"></img>
        <div className="px-6 py-2 flex items-center justify-around w-[100%]">
          ...
          <div className="text-sm w-[60%]">
            <p className="text-gray-900 leading-none text-lg font-semibold">
              {name}
            </p>
          ...
          >
            <div className="relative h-[450px] w-[80.61%] md:w-[50%]  rounded-md">
              ...
              <div className="px-6 h-[9rem]  pt-[1rem] flex flex-col  justify-around w-[100%] bottom-4 left-4 text-left bg-white">
                <div className="flex">
                  <img
                    className="w-[10.5%] h-[3rem] md:w-[9.5%] md:h-[4rem] rounded-full mr-4"
                    src={cardProfileImage}
                    alt="Avatar of Jonathan Reinink"
                  ></img>
                  ...
                  <div className="text-sm w-[40%] pt-3 flex">
                    <p className="inline-block  rounded-full px-3 pt-2 text-sm font-semibold text-gray-700 mr-2 mb-2">
                  ...
                  <div className="w-[30%] hidden md:flex items-center justify-center font-semibold ">
                    <FaRegThumbsUp />{" "}
                    <span className="pl-1">{formatLikes(likes)}</span>
                  </div>
                </div>
